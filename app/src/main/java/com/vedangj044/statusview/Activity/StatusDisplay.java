...
public class StatusDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoURL = "https://firebasestorage.googleapis.com/v0/b/aarambh-aider.appspot.com/o/images%2Fvideoplayback.mp4?alt=media";
        ...
        StatusList.add(new ImageStatusObject(imgBase64, "https://f4.bcbits.com/img/a2322320532_10.jpg", true));
        ...
        for(int i = 0; i < st1.getNumberOfStatus(); i++){
            ...
            if(sb instanceof ImageStatusObject && ((ImageStatusObject)sb).getVideo()){
                ...
                cb.setDuration(DEFAULT_TIME_STATUS_VIEW);
                front.add(cb);
            }
